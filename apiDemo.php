<?php
	...
	$gamifyCallBack = getCurlData( $apiUrl . "gift/" . idGame, [
		[
			...
			"name" => "Un mug 🦄", // (String 255) nom du lots
	...
	$gamifyCallBack = getCurlData( $apiUrl . "stats/" . idGame, [
		[
			"id" => 1, // (Int 11) identifiant unique de la donés
			"origine" => "audio", // (String 255) origine stats
			"number_call" => 12, //  (Int 11) Nombres d'appels
			"number_unfactured_call" => 6, // (Int 11) temps cumulé des appels non facturé en ms
			"number_sms" => 3, // (Int 11) nombre de sms
			"calling_duraion" => "80000", // (Int 11) temps cumulé des appels en ms
			"calling_average" => "500", // (Int 11) temps moyens des appels en ms
	...
	$gamifyCallBack = getCurlData( $apiUrl . "played/" . idGame, [
		[
			...
			"date" => "2017-05-12 00:00:00", // (Date time (0000-00-00 00:00:00) ) date de la paricipation
			"gift" => null, // (Int 11) id du lot gagné
			"phone" => "33000000000", // (String 11) n° téléphone au format international
			"phone_bis" => "33000000000", // (String 11) n° téléphone au format international bis
			...
			"address_bis" => null, // (String 255) addresse bi du participant
			...
			"no_card" => "12345678", // (Int 11) numéreaux de carte
